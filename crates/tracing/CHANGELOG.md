...
<csr-read-only-do-not-edit/>
 ...
 - 32 commits contributed to the release over the course of 252 calendar days.
 ...
 * **Uncategorized**
    ...
    - Bump to 0.3.0 ([`be57edb`](https://github.com/brooksmtownsend/wasmCloud/commit/be57edb70fe783ca71c2eadc7f27d68e5712b3e7))
    ...
    - Unused metrics functions ([`a10e171`](https://github.com/brooksmtownsend/wasmCloud/commit/a10e171e16e08f16e21ad07fff99343b10363fc9))
    - Fix compilation issue in tracing ([`f38f551`](https://github.com/brooksmtownsend/wasmCloud/commit/f38f5510fc53ea83a94378851a02c3800444388f))
    - Bump to 0.2.0 ([`53a312c`](https://github.com/brooksmtownsend/wasmCloud/commit/53a312c3c35014e1b337a45a96373b81512bc113))
    ...
    - Add invocation and error counts for actor invocations ([`7d51408`](https://github.com/brooksmtownsend/wasmCloud/commit/7d51408440509c687b01e00b77a3672a8e8c30c9))
    ...
    - Add initial support for metrics ([`17648fe`](https://github.com/brooksmtownsend/wasmCloud/commit/17648fedc2a1907b2f0c6d053b9747e72999addb))
    - Enable OTEL logs ([`3602bdf`](https://github.com/brooksmtownsend/wasmCloud/commit/3602bdf5345ec9a75e88c7ce1ab4599585bcc2d3))
    - Update the default OTLP HTTP port to match the current spec ([`cdf389b`](https://github.com/brooksmtownsend/wasmCloud/commit/cdf389bdda44fbccfb0f513d84f3737722f0a1a7))
    - Remove check for default OpenTelemetry traces path ([`71f8bc0`](https://github.com/brooksmtownsend/wasmCloud/commit/71f8bc0a19c26cb8d2d845c69a61e7f43c409d3d))
    - Normalize service.names to use kebab-case ([`2b52f08`](https://github.com/brooksmtownsend/wasmCloud/commit/2b52f083fde88b98a20dd53ba24e4ae697fcef16))
    - Address clippy warnings ([`fffc9bb`](https://github.com/brooksmtownsend/wasmCloud/commit/fffc9bb8cf42e0f5f7f03971b46dd5cdbb6d2c31))
    - Clean-up imports ([`45eea2a`](https://github.com/brooksmtownsend/wasmCloud/commit/45eea2ae0f65a0f4f403bed14feefdd67f82d0f3))
    ...
    - Split directives before trying to parse ([`8d34511`](https://github.com/brooksmtownsend/wasmCloud/commit/8d345114fbd30a3f6784d2b22fa79f1c44f807c5))
    - Proxy RUST_LOG to providers ([`691c371`](https://github.com/brooksmtownsend/wasmCloud/commit/691c3719b8030e437f565156ad5b9cff12fd4cf3))
    - Satisfy clippy linting ([`1a80eea`](https://github.com/brooksmtownsend/wasmCloud/commit/1a80eeaa1f1ba333891092f8a27e924511c0bd68))
    - Reduce verbosity of nats logs ([`46b441d`](https://github.com/brooksmtownsend/wasmCloud/commit/46b441d1358fd0ee349bf1dfc87236c400cb4db1))
    - Filter verbose logs ([`5ead09f`](https://github.com/brooksmtownsend/wasmCloud/commit/5ead09f6ee292e4923dcbfcce64ee3d6081dca2d))
    - Attach traces on inbound and outbound messages ([`74142c4`](https://github.com/brooksmtownsend/wasmCloud/commit/74142c4cff683565fb321b7b65fbb158b5a9c990))
    - Pub the context mod only with the otel feature enabled ([`45b0fb0`](https://github.com/brooksmtownsend/wasmCloud/commit/45b0fb0960921a4eebd335977fd8bc747def97a4))
    - Replace lazy_static with once_cell ([`e1d7356`](https://github.com/brooksmtownsend/wasmCloud/commit/e1d7356bb0a07af9f4e6b1626f5df33709f3ed78))
    - Update imports ([`a8538fb`](https://github.com/brooksmtownsend/wasmCloud/commit/a8538fb7926b190a180bdd2b46ad00757d98759a))
    - Construct a strongly typed HostData to send to providers ([`23f1759`](https://github.com/brooksmtownsend/wasmCloud/commit/23f1759e818117f007df8d9b1bdfdfa7710c98c5))
