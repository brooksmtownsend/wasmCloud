...
<csr-read-only-do-not-edit/>
 ...
 - 80 commits contributed to the release over the course of 1250 calendar days.
 - 64 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 9 unique issues were worked on: [#16](https://github.com/brooksmtownsend/wasmCloud/issues/16), [#25](https://github.com/brooksmtownsend/wasmCloud/issues/25), [#32](https://github.com/brooksmtownsend/wasmCloud/issues/32), [#37](https://github.com/brooksmtownsend/wasmCloud/issues/37), [#40](https://github.com/brooksmtownsend/wasmCloud/issues/40), [#49](https://github.com/brooksmtownsend/wasmCloud/issues/49), [#67](https://github.com/brooksmtownsend/wasmCloud/issues/67), [#81](https://github.com/brooksmtownsend/wasmCloud/issues/81), [#84](https://github.com/brooksmtownsend/wasmCloud/issues/84)
 ...
 * **[#16](https://github.com/brooksmtownsend/wasmCloud/issues/16)**
    - Safety/WIP checkin. Partially done implementing control interface ([`308bbe4`](https://github.com/brooksmtownsend/wasmCloud/commit/308bbe4605f2f21359a7eed8518a8fe844a4f149))
 * **[#25](https://github.com/brooksmtownsend/wasmCloud/issues/25)**
    - Implementation of the scheduling auction client and host functionality ([`617555f`](https://github.com/brooksmtownsend/wasmCloud/commit/617555f8412b5485c266585c031a9a4332eb70af))
 * **[#32](https://github.com/brooksmtownsend/wasmCloud/issues/32)**
    - Initial implementation of actor update functionality ([`2390d79`](https://github.com/brooksmtownsend/wasmCloud/commit/2390d79063f3df58a8f358010839462a3f8e77a1))
 * **[#37](https://github.com/brooksmtownsend/wasmCloud/issues/37)**
    - Adding support for RPC invocations over control interface ([`f411d06`](https://github.com/brooksmtownsend/wasmCloud/commit/f411d06fb5cadda900928e620407538213aa5c2c))
 * **[#40](https://github.com/brooksmtownsend/wasmCloud/issues/40)**
    - Fixing topic prefixes ([`e968243`](https://github.com/brooksmtownsend/wasmCloud/commit/e968243a954806086f4cf2ae6f586a2a8207422e))
 * **[#49](https://github.com/brooksmtownsend/wasmCloud/issues/49)**
    - Convert lattice cache (networked and offline) into use of capability provider ([`6b47d05`](https://github.com/brooksmtownsend/wasmCloud/commit/6b47d050fd85883758518ff069a74b6eca5627a9))
 * **[#67](https://github.com/brooksmtownsend/wasmCloud/issues/67)**
    - Control interface start actor and provider now acknowledge prior to downloading OCI bytes ([`e6c228e`](https://github.com/brooksmtownsend/wasmCloud/commit/e6c228e70f433a1d2e6049d702c1841652c449d2))
 * **[#81](https://github.com/brooksmtownsend/wasmCloud/issues/81)**
    - Remove git dependencies ([`3d3bd2d`](https://github.com/brooksmtownsend/wasmCloud/commit/3d3bd2d7542efe037e56b1ea98e401cae1252fd5))
 * **[#84](https://github.com/brooksmtownsend/wasmCloud/issues/84)**
    - Updated crate READMEs, additional build/release actions, increased echo delay ([`9643645`](https://github.com/brooksmtownsend/wasmCloud/commit/9643645b18bf4d1478e4cf7666e7c576d9ed5ce0))
 * **Uncategorized**
    ...
    - Bump to v1.0.0 ([`4a51868`](https://github.com/brooksmtownsend/wasmCloud/commit/4a51868f45b6bff8472b1e9337ca83243ee102e8))
    - Indicate get_response usage ([`7d0a977`](https://github.com/brooksmtownsend/wasmCloud/commit/7d0a9774b24c182b0e38ecaa0c1c4383c517af45))
    ...
    - Bump v1.0.0-alpha.3 ([`0c193ff`](https://github.com/brooksmtownsend/wasmCloud/commit/0c193ff7cdf626b1ad8da11f933456d21be21246))
    - Rename actor to component ([`d4bf78a`](https://github.com/brooksmtownsend/wasmCloud/commit/d4bf78a704affaa84808fb167d3ab1636ffc35ac))
    - Bump to v1.0.0-alpha.2 ([`74eb752`](https://github.com/brooksmtownsend/wasmCloud/commit/74eb7525a8b0a32d5dfaeb16d347ef3a0ec48b7c))
    - Rename actor_scale* events ([`9e23be2`](https://github.com/brooksmtownsend/wasmCloud/commit/9e23be23131bbcdad746f7e85d33d5812e5f2ff9))
    ...
    - Bump to 1.0.0-alpha.1 ([`647a635`](https://github.com/brooksmtownsend/wasmCloud/commit/647a6358ffd0355bf00fb53aef18d937ee0e5324))
    - Flatten claims response payload ([`cab6fd2`](https://github.com/brooksmtownsend/wasmCloud/commit/cab6fd2cae47f0a866f17dfdb593a48a9210bab8))
    ...
    - Support static named config for providers ([`36c70a6`](https://github.com/brooksmtownsend/wasmCloud/commit/36c70a6e572eeefc4fd211baef3934c691af2679))
    ...
    - Glues in named config to actors ([`82c249b`](https://github.com/brooksmtownsend/wasmCloud/commit/82c249b15dba4dbe4c14a6afd2b52c7d3dc99985))
    - Wrap all operations in CtlResponse ([`4c54a48`](https://github.com/brooksmtownsend/wasmCloud/commit/4c54a488f5ea4a7d5f6793db62c9e2b0fd6ddf3a))
    - Consistent link operations ([`301ba5a`](https://github.com/brooksmtownsend/wasmCloud/commit/301ba5aacadfe939db5717eb9cff47a31fffd116))
    - Remove collection type aliases ([`e16da66`](https://github.com/brooksmtownsend/wasmCloud/commit/e16da6614ad9ae28e8c3e6ac3ebb36faf12cb4d1))
    - Flatten instances on actor/providers ([`49aba5d`](https://github.com/brooksmtownsend/wasmCloud/commit/49aba5d593d1d2a5ef10c46bb412be434bcf7e49))
    - Feat(control-interface)!: add component ID, remove unneeded parameters from payloads for wrpc ([`a9518e0`](https://github.com/brooksmtownsend/wasmCloud/commit/a9518e0b567685fa2c6bf0d9d8aca80498c79da9))
    - Fully support interface links, remove aliases ([`48fc893`](https://github.com/brooksmtownsend/wasmCloud/commit/48fc893ba2de576511aeea98a3da4cc97024c53e))
    - Add wasmcloud-test-util crate ([`4803b7f`](https://github.com/brooksmtownsend/wasmCloud/commit/4803b7f2381b5439f862746407ac13a31ebdfee3))
    ...
    - Added InterfaceLinkDefinition ([`85a550d`](https://github.com/brooksmtownsend/wasmCloud/commit/85a550d889d18ce4e437f88cbd8b3d127a9e5fbe))
    - Changes config topic to be for named config ([`1d46c28`](https://github.com/brooksmtownsend/wasmCloud/commit/1d46c284e32d2623d0b105014ef0c2f6ebc7e079))
    ...
    - Enable OTEL logs ([`3602bdf`](https://github.com/brooksmtownsend/wasmCloud/commit/3602bdf5345ec9a75e88c7ce1ab4599585bcc2d3))
    - V0.33.0 ([`6417be8`](https://github.com/brooksmtownsend/wasmCloud/commit/6417be87afb6df3e14892022148f38815056104c))
    - Fix compilation ([`215b492`](https://github.com/brooksmtownsend/wasmCloud/commit/215b492a1297fd35577e428dee25c1407ef8e6e2))
    - Allow receiving specific events ([`1753549`](https://github.com/brooksmtownsend/wasmCloud/commit/1753549d210c41405c9f2758ec857adc1505b61a))
    - Rename lattice prefix to just lattice ([`6e8faab`](https://github.com/brooksmtownsend/wasmCloud/commit/6e8faab6a6e9f9bb7327ffb71ded2a83718920f7))
    - Add heartbeat fields to inventory ([`2e8893a`](https://github.com/brooksmtownsend/wasmCloud/commit/2e8893af27700b86dbeb63e5e7fc4252ec6771e1))
    - Remove singular actor events, add actor_scaled ([`df01bbd`](https://github.com/brooksmtownsend/wasmCloud/commit/df01bbd89fd2b690c2d1bcfe68455fb827646a10))
    - Upgrade max_instances to u32 ([`5cca9ee`](https://github.com/brooksmtownsend/wasmCloud/commit/5cca9ee0a88d63cb53e8d352c16a5d9d59966bc8))
    - Rename max-concurrent to max-instances, simplify scale ([`d8eb9f3`](https://github.com/brooksmtownsend/wasmCloud/commit/d8eb9f3ee9df65e96d076a6ba11d2600d0513207))
    - Bump to 0.32.1 ([`39d4de5`](https://github.com/brooksmtownsend/wasmCloud/commit/39d4de57e25af8cb4686d53410037c1cc93027ba))
    - Remove deprecated code related to start actor cmd ([`7de3182`](https://github.com/brooksmtownsend/wasmCloud/commit/7de31820034c4b70ab6edc772713e64aafe294a9))
    - Update parsing from RegistryCredential to RegistryAuth ([`65d2e28`](https://github.com/brooksmtownsend/wasmCloud/commit/65d2e28d54929b8f4d0b39077ee82ddad2387c8e))
    - Revised implementation of registry url and credentials resolution ([`57d014f`](https://github.com/brooksmtownsend/wasmCloud/commit/57d014fb7fe11542d2e64068ba86e42a19f64f98))
    - Some cleanup before revised implementation ([`4e9bae3`](https://github.com/brooksmtownsend/wasmCloud/commit/4e9bae34fe95ecaffbc81fd452bf29746b4e5856))
    - Add event name as suffix on event topic ([`6994a22`](https://github.com/brooksmtownsend/wasmCloud/commit/6994a2202f856da93d0fe50e40c8e72dd3b7d9e6))
    - Rename label to key ([`bdb72ee`](https://github.com/brooksmtownsend/wasmCloud/commit/bdb72eed8778a5d8c59d0b8939f147c374cb671f))
    - Enable updating host labels via the control interface ([`85cb573`](https://github.com/brooksmtownsend/wasmCloud/commit/85cb573d29c75eae4fdaca14be808131383ca3cd))
    - Adds support for actor config ([`1a048a7`](https://github.com/brooksmtownsend/wasmCloud/commit/1a048a71320dbbf58f331e7e958f4b1cd5ed4537))
    - V0.32.0 ([`a61723a`](https://github.com/brooksmtownsend/wasmCloud/commit/a61723a12a298f10e28eb7464a2bb623b5cfe244))
    - Update `wasmcloud-control-interface` ([`17db669`](https://github.com/brooksmtownsend/wasmCloud/commit/17db669d79e242144eeffbd8d2ac2b1ae9edeb35))
    - Reverting back to simple util method call for identifier verification ([`d3e6269`](https://github.com/brooksmtownsend/wasmCloud/commit/d3e6269dc1441b21d4c06d7620e9e7c6d839e211))
    - Remove initial test function. ([`ae3c37c`](https://github.com/brooksmtownsend/wasmCloud/commit/ae3c37c61b20c38abbf8e09b37c546dd1db4db42))
    - Trying out "nominal typing" for validating identifiers. Only HostId implemented. ([`413410b`](https://github.com/brooksmtownsend/wasmCloud/commit/413410bad26d148aeda28b6403add7842570efac))
    - Validate identifier inputs ([`f8846e0`](https://github.com/brooksmtownsend/wasmCloud/commit/f8846e022a49d4c9158250af1ab9ae6661bceaf0))
    - Remove support for bindle references ([`5301084`](https://github.com/brooksmtownsend/wasmCloud/commit/5301084bde0db0c65811aa30c48de2a63e091fcf))
    - Fix lint ([`f43d882`](https://github.com/brooksmtownsend/wasmCloud/commit/f43d88283ddc17ed81b1f95bf64b5985bda70fd3))
    - Simplify `collect_sub_timeout` ([`79a8f1b`](https://github.com/brooksmtownsend/wasmCloud/commit/79a8f1b03a63a4b5a5295cdf86ef69780bade052))
    - Remove `sub_stream` module ([`b604a8c`](https://github.com/brooksmtownsend/wasmCloud/commit/b604a8c7a5f1c9d3b417a178d68d90104d817b3a))
    - Address clippy warnings ([`723ae50`](https://github.com/brooksmtownsend/wasmCloud/commit/723ae50ea0eff41875f65622ba72cf2c4f53489f))
    - Remove unused `HeaderInjector` ([`98a5952`](https://github.com/brooksmtownsend/wasmCloud/commit/98a59529e451214d61acdffe4703552a5f4a231a))
    - Clean-up imports ([`f8c2d51`](https://github.com/brooksmtownsend/wasmCloud/commit/f8c2d51f1b049e2035ea0d5df096a129482da7e4))
    - Merge pull request #927 from rvolosatovs/merge/control-interface ([`5d40fcb`](https://github.com/brooksmtownsend/wasmCloud/commit/5d40fcb06f4a029cca05f0d5b5f8c12722553822))
    - Integrate `control-interface` into the workspace ([`18791e7`](https://github.com/brooksmtownsend/wasmCloud/commit/18791e7666b4de2526628e2a973c47b7f51d9481))
    - Add 'crates/control-interface/' from commit 'cea335729f3bf368178cc6b8745478bdd01c54b5' ([`84fc7a9`](https://github.com/brooksmtownsend/wasmCloud/commit/84fc7a928697c8fc9c6a03e94ed2053783577a4f))
    - Merge pull request #39 from brooksmtownsend/pub-mod-but-not-too-pub ([`9ed226d`](https://github.com/brooksmtownsend/wasmCloud/commit/9ed226d3eece88def03af7c173e5777d6b9d4823))
    - Merge remote-tracking branch 'upstream/main' into release_gh ([`c02921b`](https://github.com/brooksmtownsend/wasmCloud/commit/c02921bf17cf14767894449df08b886aab2e9eed))
    - Make only Invocation and InvocationResponse public ([`0154b89`](https://github.com/brooksmtownsend/wasmCloud/commit/0154b8943795c7925b94bfa3a1aa4f4da1b75854))
    - Merge pull request #38 from brooksmtownsend/make-mod-pub ([`27232ff`](https://github.com/brooksmtownsend/wasmCloud/commit/27232ffacf3b5d277328c6821b3cd25479f8bda9))
    - Make inv mod public for control_interface imports ([`92c80c1`](https://github.com/brooksmtownsend/wasmCloud/commit/92c80c11d35421d6ed3899d0e32651f177697772))
</details>
